...
global previous
main = Tk()
myFont = Font(family="Helvetica", size=13)
s = ttk.Style()
s.configure('TFrame', background='#0')
main.title("LabCS")
main.geometry("1900x1000")
frame = ttk.Frame(main, width=1900, height=1100, style='TFrame', padding=(4, 4, 450, 450))
...
def check():
    ...
    frame2 = Frame(main, bd=10, bg='#140000', highlightthickness=20)
    frame2.config(highlightbackground="Gray")
    frame2.place(relx=0.5, rely=0.1, width=800, relwidth=0.4, relheight=0.8, anchor='n')

    text2 = Text(frame2, bg="#bdbfff", width=50, height=27.5, highlightthickness=3)
    text2.place(relx=0.07, rely=0.03, relwidth=0.4, relheight=0.9)
    text2.insert(END, '\n\n'.join(success))



    listbox_fail = Listbox(frame2, bg="#bdbfff", font=myFont, fg="white", listvariable=vars2, selectmode=MULTIPLE,
    ...
    exit_btn = Button(frame2, text='Back', command=exit, bg="#300000", fg="white", font=myFont, padx='10px',
                      pady='3px')
...
lstbox = Listbox(frame, bg="#0d102b", font=myFont, fg="white", listvariable=vars, selectmode=MULTIPLE, width=130,
...
text = Text(frame, bg="#144100", fg="white", font=myFont, width=67, height=40, highlightthickness=3)
text.config(highlightbackground="white")
text.grid(row=0, column=3, columnspan=3, padx=30)
import_button = Button(frame, bg="#a82525", fg="white", font=myFont, text="Import", width=7, height=1,
                       command=import_audit).place(relx=0.01, rely=0.849)
saveButton = Button(frame, bg="#2d35a6", fg="white", font=myFont, text="Save", width=7, height=1,
                    command=save_config).place(relx=0.01, rely=0.099)
selectAllButton = Button(frame, bg="#128c45", fg="white", font=myFont, text="Select All", width=7, height=1,
                         command=select_all).place(relx=0.60, rely=0.849)
deselectAllButton = Button(frame, bg="#128c45", fg="white", font=myFont, text="Deselect All", width=10, height=1,
                           command=deselect_all).place(relx=0.546, rely=0.849)
downloadButton = Button(frame, bg="#a82525", fg="white", font=myFont, text="Download audits", width=15, height=1,
                        command=extract_download).place(relx=0.050, rely=0.849)
global e
e = Entry(frame, bg="#ffe4d1", font=myFont, width=30, textvariable=querry).place(relx=0.41, rely=0.910)
search_button = Button(frame, bg="#ffffff", fg="black", font=myFont, text="Search", width=7, height=1,
                       command=search).place(relx=0.56, rely=0.910)
check_button = Button(frame, bg="#5e0202", fg="white", font=myFont, text="Check", width=7, height=1,
